...
const outputDirs = [path.join(rootDir, 'src/assets'), path.join(rootDir, 'dist/demchukdenys/browser')];

const staticRoutes = ['/', '/portfolios', '/services', '/articles', '/3d-models', '/kitchen-calculator'];
const dynamicRoutes = [
...
const routes = [...staticRoutes, ...dynamicRoutes].filter((route) => isIndexable(route, pageSeo));
